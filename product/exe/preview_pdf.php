<?php
	...
	array_push($students ,new Student('Laura Blondeau', 'MDS B1', '', 50, 1));
	array_push($students ,new Student('Laura Blondeau', 'MDS B1', '', 68, 1));
			   ...
			   <tbody> <!-- Corps du tableau -->
				  <?php
				   for($i = 0; $i < sizeof($absentiaList->_students); $i++){
					...
					}else if($current_student->_hours_missed>=30 && $current_student->_hours_missed<50){
					 	echo('<td>Conseil</td>');
					}else if($current_student->_hours_missed>=50 && $current_student->_hours_missed<60){
						echo('<td>Exclusion à 60h</td>');
					}else if($current_student->_hours_missed>=60){
